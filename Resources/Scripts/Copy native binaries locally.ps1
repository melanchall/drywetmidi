...
Write-Host "Copying x64 so..."
$linuxX64Destination = "Native\linux_x64"
New-Item -ItemType Directory -Force -Path $linuxX64Destination
Copy-Item -Path "$fromDirectory/Native_Linux_x64/Melanchall_DryWetMidi_Native.so" -Destination "$linuxX64Destination" -Force -Verbose