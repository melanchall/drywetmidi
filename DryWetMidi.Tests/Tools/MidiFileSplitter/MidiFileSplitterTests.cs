...
namespace Melanchall.DryWetMidi.Tests.Tools
{
    ...
    public sealed class MidiFileSplitterTests
    {
        ...
        [TestCase(0)]
        [TestCase(5)]
        public void SplitByGrid_PartStartMarkerEventFactory_PreserveTimes(long firstEventTime)
        {
            var timedEvents = new[]
            {
        ...
        [TestCase(0)]
        [TestCase(5)]
        public void SplitByGrid_PartStartMarkerEventFactory_DontPreserveTimes(long firstEventTime)
        {
            var timedEvents = new[]
            {
                new TimedEvent(new TextEvent("A"), firstEventTime),
        ...
        [Test]
        public void SplitByGrid_PartEndMarkerEventFactory_PreserveTimes()
        {
            var timedEvents = new[]
            {
        ...
        [Test]
        public void SplitByGrid_PartEndMarkerEventFactory_DontPreserveTimes()
        {
            var timedEvents = new[]
            {
                new TimedEvent(new TextEvent("A"), 0),
        ...
        [TestCase(0)]
        [TestCase(5)]
        public void SplitByGrid_PartStartMarkerEventFactory_PartEndMarkerEventFactory_PreserveTimes(long firstEventTime)
        {
            var timedEvents = new[]
            {
                new TimedEvent(new TextEvent("A"), firstEventTime),
        ...
        [TestCase(0)]
        [TestCase(5)]
        public void SplitByGrid_PartStartMarkerEventFactory_PartEndMarkerEventFactory_DontPreserveTimes(long firstEventTime)
        {
            var timedEvents = new[]
            {
                new TimedEvent(new TextEvent("A"), firstEventTime),
