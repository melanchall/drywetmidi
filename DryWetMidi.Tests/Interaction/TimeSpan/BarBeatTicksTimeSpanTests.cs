...
namespace Melanchall.DryWetMidi.Tests.Interaction
{
    ...
    public sealed class BarBeatTicksTimeSpanTests
    {
        ...
        {
            new object[] { new BarBeatTicksTimeSpan(), "0.0.0" },
            new object[] { new BarBeatTicksTimeSpan(10, 0, 0), "10.0.0" },
            new object[] { new BarBeatTicksTimeSpan(100, 100, 100), "100.100.100" },
            new object[] { new BarBeatTicksTimeSpan(0, 345, 0), "0.345.0" },
            new object[] { new BarBeatTicksTimeSpan(0, 0, 1234), "0.0.1234" },
            new object[] { new BarBeatTicksTimeSpan(10.2, 0.3, 0), "10,2.0,3.0" },
            new object[] { new BarBeatTicksTimeSpan(10.2, 0.001, 0), "10,2.0,001.0" },
        ...
        //  ^                   ^                   ^
        [Test]
        public void Convert_Default_1() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(2, 0),
        ...
        //       '              ^                   ^    '
        [Test]
        public void Convert_Default_2() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(2, 0),
            2 * MusicalTimeSpan.Whole,
        ...
        //                             '        ^                                   ^
        [Test]
        public void Convert_Default_3() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(1, 2, 60),
        ...
        //                 '    ^                   ^
        [Test]
        public void Convert_Default_4() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(1, 1),
        ...
        //                 '    ^                   ^
        [Test]
        public void Convert_Default_5() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(1, 1, 90),
        ...
        //                 '    ^    '
        [Test]
        public void Convert_Default_6() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(0, 2),
        ...
        //                           '    '    '
        [Test]
        public void Convert_Default_7() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(0, 2),
            MusicalTimeSpan.Half,
            MusicalTimeSpan.Whole + MusicalTimeSpan.Quarter,
            TimeSpanTestUtilities.DefaultTempoMap);
        ...
        //                                     '    ^
        [Test]
        public void Convert_Default_8() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(0, 1),
            MusicalTimeSpan.Quarter,
        ...
        //                                              ^
        [Test]
        public void Convert_Default_9() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(0, 1),
            MusicalTimeSpan.Quarter,
        ...
        [Test]
        public void Convert_Default_FromMaxTicks() => ClassicAssert.DoesNotThrow(() =>
            TimeConverter.ConvertTo<BarBeatTicksTimeSpan>(long.MaxValue, TimeSpanTestUtilities.DefaultTempoMap));

        [Test]
        public void Convert_Default_FromMaxTimeSpan() => ClassicAssert.Throws<InvalidOperationException>(() =>
        ...
        //  ^                   ^              ^
        [Test]
        public void Convert_Simple_1() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(2, 0),
        ...
        //  ^                   ^  '  '  '
        [Test]
        public void Convert_Simple_2() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(1, 3),
        ...
        //       '    '    '
        [Test]
        public void Convert_Simple_3() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(0, 2),
            MusicalTimeSpan.Half,
            MusicalTimeSpan.Quarter,
            TimeSpanTestUtilities.SimpleTempoMap);
        ...
        //                         '  '  '
        [Test]
        public void Convert_Simple_4() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(0, 2),
            MusicalTimeSpan.Quarter,
        ...
        //            '    '    ^  '  '  '
        [Test]
        public void Convert_Simple_5() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(1, 1),
        ...
        //            '    '    ^              ^ ' ' '
        [Test]
        public void Convert_Simple_6() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(2, 1),
        ...
        //                      ^              ^ ' '
        [Test]
        public void Convert_Simple_7() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(1, 2),
        ...
        //            '    '    ^              ^
        [Test]
        public void Convert_Simple_8() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(1, 2),
        ...
        //                                  ^              ^
        [Test]
        public void Convert_Simple_9() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(1, 1, 60),
        ...
        //            '    '    ^
        [Test]
        public void Convert_Simple_10() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(0, 2, 60),
        ...
        //             |===|
        [Test]
        public void Convert_Simple_11() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(0, 0, 90),
        ...
        //                          |===|
        [Test]
        public void Convert_Simple_12() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(0, 0, 90),
            3 * MusicalTimeSpan.SixtyFourth,
        ...
        //                            '  '  '  ^ '
        [Test]
        public void Convert_Simple_13() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(0, 4, 0),
        ...
        //                                     '  '  ^
        [Test]
        public void Convert_Simple_14() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(0, 3, 30),
        ...
        //                                  ^  '  '  '  '
        [Test]
        public void Convert_Simple_15() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(0, 4, 240),
        ...
        //            '    '    ^                   ^              ^         ^ ' '
        [Test]
        public void Convert_Complex_1() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(4, 0),
        ...
        //            '    '    ^                   ^              ^         ^         ^ '
        [Test]
        public void Convert_Complex_2() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(4, 3),
        ...
        //                                '    '    ^              ^         ^         ^         ^  '  '  '
        [Test]
        public void Convert_Complex_3() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(5, 1),
        ...
        //                                                                                 ' ' ' ^  '  '
        [Test]
        public void Convert_Complex_4() => TimeSpanTestUtilities.TestConversion(
            new BarBeatTicksTimeSpan(1, 0),
        ...
        {
            ClassicAssert.AreEqual(
                new BarBeatTicksTimeSpan(20, 10, 18),
        ...
        {
            ClassicAssert.AreEqual(
                new BarBeatTicksTimeSpan(15, 12, 9),
        ...
        {
            ClassicAssert.AreEqual(
                new BarBeatTicksTimeSpan(7.5, 4.5, 9),
                new BarBeatTicksTimeSpan(5, 3, 6).Multiply(1.5));
        }
        ...
        {
            ClassicAssert.AreEqual(
                new BarBeatTicksTimeSpan(2.5, 1.5, 3),
                new BarBeatTicksTimeSpan(5, 3, 6).Multiply(0.5));
        }
        ...
        {
            ClassicAssert.AreEqual(
                new BarBeatTicksTimeSpan(5, 4, 3),
        ...
        {
            ClassicAssert.AreEqual(
                new BarBeatTicksTimeSpan(5, 3, 4),
        ...
        {
            ClassicAssert.AreEqual(
                new BarBeatTicksTimeSpan(8, 2, 4),
        ...
        [Test]
        public void Divide_7()
        {
            ClassicAssert.AreEqual(
                new BarBeatTicksTimeSpan(0.5, 1.5, 9),
                new BarBeatTicksTimeSpan(0.5, 1.5, 9).Divide(1));
        }

        [Test]
        public void Divide_8()
        {
            ClassicAssert.AreEqual(
                new BarBeatTicksTimeSpan(2, 10 / 3.0, 6),
                new BarBeatTicksTimeSpan(3, 5, 9).Divide(1.5));
        }
        ...
        public void ToString(BarBeatTicksTimeSpan timeSpan, string expectedString)
        {
