...
namespace Melanchall.DryWetMidi.Tests.Interaction
{
    ...
    public sealed partial class NotesManagingUtilitiesTests
    {
        ...
        [Test]
        public void GetNotes_DetectionSettings_TrackChunks_FirstNoteOn_2([Values] bool wrapToFile) => GetNotes_DetectionSettings_TrackChunks(
            wrapToFile,
            new NoteDetectionSettings { NoteStartDetectionPolicy = NoteStartDetectionPolicy.FirstNoteOn },
            midiEvents: new[]
            {
        ...
        [Test]
        public void GetNotes_DetectionSettings_TrackChunks_FirstNoteOn_3([Values] bool wrapToFile) => GetNotes_DetectionSettings_TrackChunks(
            wrapToFile,
            new NoteDetectionSettings { NoteStartDetectionPolicy = NoteStartDetectionPolicy.FirstNoteOn },
            midiEvents: new[]
            {
        ...
        [Test]
        public void GetNotes_DetectionSettings_TrackChunks_FirstNoteOn_5([Values] bool wrapToFile) => GetNotes_DetectionSettings_TrackChunks(
            wrapToFile,
            new NoteDetectionSettings { NoteStartDetectionPolicy = NoteStartDetectionPolicy.FirstNoteOn },
            midiEvents: new[]
            {
        ...
        [Test]
        public void GetNotes_DetectionSettings_TrackChunks_LastNoteOn_2([Values] bool wrapToFile) => GetNotes_DetectionSettings_TrackChunks(
            wrapToFile,
            new NoteDetectionSettings { NoteStartDetectionPolicy = NoteStartDetectionPolicy.LastNoteOn },
            midiEvents: new[]
            {
        ...
        [Test]
        public void GetNotes_DetectionSettings_TrackChunks_LastNoteOn_3([Values] bool wrapToFile) => GetNotes_DetectionSettings_TrackChunks(
            wrapToFile,
            new NoteDetectionSettings { NoteStartDetectionPolicy = NoteStartDetectionPolicy.LastNoteOn },
            midiEvents: new[]
            {
        ...
        [Test]
        public void GetNotes_DetectionSettings_TrackChunks_LastNoteOn_6([Values] bool wrapToFile) => GetNotes_DetectionSettings_TrackChunks(
            wrapToFile,
            new NoteDetectionSettings { NoteStartDetectionPolicy = NoteStartDetectionPolicy.LastNoteOn },
            midiEvents: new[]
            {
            ...
            IEnumerable<Note> expectedNotes)
        {
            ...
            MidiAsserts.AreEqual(expectedNotes, timedObjects, "Notes are invalid.");
        }
