...
namespace Melanchall.DryWetMidi.Tests.Interaction
{
    ...
    public sealed partial class GetObjectsUtilitiesTests
    {
        ...
        public void GetObjects_NotesAndRests_NoSeparation_FromNotes(byte channel1, byte channel2, byte noteNumber1, byte noteNumber2) => GetObjects_NotesAndRests(
        ...
        [TestCase(10, 10)]
        [TestCase(10, 50)]
        public void GetObjects_NotesAndRests_SeparateByChannel_SingleChannel_FromNotes(byte noteNumber1, byte noteNumber2)
        {
        ...
        [TestCase(10, 10)]
        [TestCase(10, 50)]
        public void GetObjects_NotesAndRests_SeparateByChannel_DifferentChannels_FromNotes(byte noteNumber1, byte noteNumber2)
        {
        ...
        [TestCase(10, 10)]
        [TestCase(10, 5)]
        public void GetObjects_NotesAndRests_SeparateByNoteNumber_SingleNoteNumber_FromNotes(byte channel1, byte channel2)
        {
        ...
        [TestCase(10, 10)]
        [TestCase(10, 5)]
        public void GetObjects_NotesAndRests_SeparateByNoteNumber_DifferentNoteNumbers_FromNotes(byte channel1, byte channel2)
        {
        ...
        [TestCase(10, 10, 50, 100)]
        [TestCase(10, 2, 50, 100)]
        public void GetObjects_NotesAndRests_NoSeparation_FromNotesAndTimedEvents(byte channel1, byte channel2, byte noteNumber1, byte noteNumber2)
        {
            GetObjects_NotesAndRests(
                restSeparationPolicy: RestSeparationPolicy.NoSeparation,
                inputObjects: new ITimedObject[]
        ...
        [TestCase(10, 10)]
        [TestCase(10, 50)]
        public void GetObjects_NotesAndRests_SeparateByChannel_SingleChannel_FromNotesAndTimedEvents(byte noteNumber1, byte noteNumber2)
        {
            var channel = (FourBitNumber)10;
        ...
        [TestCase(10, 10)]
        [TestCase(10, 50)]
        public void GetObjects_NotesAndRests_SeparateByChannel_DifferentChannels_FromNotesAndTimedEvents(byte noteNumber1, byte noteNumber2)
        {
            var channel1 = (FourBitNumber)10;
            var channel2 = (FourBitNumber)2;
        ...
        [TestCase(10, 10)]
        [TestCase(10, 5)]
        public void GetObjects_NotesAndRests_SeparateByNoteNumber_SingleNoteNumber_FromNotesAndTimedEvents(byte channel1, byte channel2)
        {
            var noteNumber = (SevenBitNumber)10;
        ...
        [TestCase(10, 10)]
        [TestCase(10, 5)]
        public void GetObjects_NotesAndRests_SeparateByNoteNumber_DifferentNoteNumbers_FromNotesAndTimedEvents(byte channel1, byte channel2)
        {
            var noteNumber1 = (SevenBitNumber)10;
            var noteNumber2 = (SevenBitNumber)100;
        ...
        [TestCase(10, 10, 50, 100)]
        [TestCase(10, 2, 50, 100)]
        public void EnumerateObjects_NotesAndRests_NoSeparation_2(byte channel1, byte channel2, byte noteNumber1, byte noteNumber2)
        {
            EnumerateObjects_NotesAndRests(
                restSeparationPolicy: RestSeparationPolicy.NoSeparation,
                inputEvents: new ITimedObject[]
                {
                    new Note((SevenBitNumber)noteNumber1, 100, 10) { Channel = (FourBitNumber)channel2 },
        ...
        [TestCase(10, 50)]
        public void EnumerateObjects_NotesAndRests_SeparateByChannel_SingleChannel_1(byte noteNumber1, byte noteNumber2)
        {
            var channel = (FourBitNumber)10;
        ...
        [TestCase(10, 50)]
        public void EnumerateObjects_NotesAndRests_SeparateByChannel_SingleChannel_2(byte noteNumber1, byte noteNumber2)
        {
            var channel = (FourBitNumber)10;
        ...
        [TestCase(10, 10)]
        [TestCase(10, 50)]
        public void EnumerateObjects_NotesAndRests_SeparateByChannel_DifferentChannels_1(byte noteNumber1, byte noteNumber2)
        {
            var channel1 = (FourBitNumber)10;
            var channel2 = (FourBitNumber)2;
        ...
        [TestCase(10, 10)]
        [TestCase(10, 50)]
        public void EnumerateObjects_NotesAndRests_SeparateByChannel_DifferentChannels_2(byte noteNumber1, byte noteNumber2)
        {
            var channel1 = (FourBitNumber)10;
            var channel2 = (FourBitNumber)2;
        ...
        [TestCase(10, 5)]
        public void EnumerateObjects_NotesAndRests_SeparateByNoteNumber_SingleNoteNumber_1(byte channel1, byte channel2)
        {
            var noteNumber = (SevenBitNumber)10;
        ...
        [TestCase(10, 5)]
        public void EnumerateObjects_NotesAndRests_SeparateByNoteNumber_SingleNoteNumber_2(byte channel1, byte channel2)
        {
            var noteNumber = (SevenBitNumber)10;
        ...
        [TestCase(10, 5)]
        public void EnumerateObjects_NotesAndRests_SeparateByNoteNumber_DifferentNoteNumbers_1(byte channel1, byte channel2)
        {
            var noteNumber1 = (SevenBitNumber)10;
            var noteNumber2 = (SevenBitNumber)100;
        ...
        [TestCase(10, 10)]
        [TestCase(10, 5)]
        public void EnumerateObjects_NotesAndRests_SeparateByNoteNumber_DifferentNoteNumbers_2(byte channel1, byte channel2)
        {
            var noteNumber1 = (SevenBitNumber)10;
            var noteNumber2 = (SevenBitNumber)100;
        ...
        [Test]
        public void EnumerateObjects_NotesAndRests_SeparateByChannelAndNoteNumber_1()
        {
            var noteNumber1 = (SevenBitNumber)10;
            var noteNumber2 = (SevenBitNumber)100;
            var channel1 = (FourBitNumber)10;
        ...
        [Test]
        public void EnumerateObjects_NotesAndRests_SeparateByChannelAndNoteNumber_2()
        {
            var noteNumber1 = (SevenBitNumber)10;
            var noteNumber2 = (SevenBitNumber)100;
            var channel1 = (FourBitNumber)10;
        ...
        private void EnumerateObjects_NotesAndRests(
            RestSeparationPolicy restSeparationPolicy,
