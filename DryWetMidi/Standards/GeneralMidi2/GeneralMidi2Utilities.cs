    ...
    internal static class GeneralMidi2Utilities
    {
        ...
        private static readonly Dictionary<GeneralMidi2Program, GeneralMidi2ProgramData> ProgramsData = new[]
        {
            ...
            GetProgramsData(GeneralMidiProgram.ElectricPiano1,
                ...
                GeneralMidi2Program.ElectricPiano1_VelocityMix,
            ...
            GetProgramsData(GeneralMidiProgram.ElectricPiano2,
                ...
                GeneralMidi2Program.ElectricPiano2_VelocityMix,
            ...
            GetProgramsData(GeneralMidiProgram.Harpsichord,
                ...
                GeneralMidi2Program.Harpsichord_OctaveMix,
                GeneralMidi2Program.Harpsichord_Wide,
                GeneralMidi2Program.Harpsichord_WithKeyOff),
            ...
            GetProgramsData(GeneralMidiProgram.ChurchOrgan,
                ...
                GeneralMidi2Program.ChurchOrgan_OctaveMix,
            ...
            GetProgramsData(GeneralMidiProgram.AcousticGuitar1,
                GeneralMidi2Program.AcousticGuitar_Nylon,
                GeneralMidi2Program.Ukulele,
                GeneralMidi2Program.AcousticGuitar_NylonKeyOff,
                GeneralMidi2Program.AcousticGuitar_Nylon2),
            GetProgramsData(GeneralMidiProgram.AcousticGuitar2,
                GeneralMidi2Program.AcousticGuitar_Steel,
            ...
            GetProgramsData(GeneralMidiProgram.ElectricGuitar1,
                GeneralMidi2Program.ElectricGuitar_Jazz,
                GeneralMidi2Program.ElectricGuitar_PedalSteel),
            GetProgramsData(GeneralMidiProgram.ElectricGuitar2,
                GeneralMidi2Program.ElectricGuitar_Clean,
                GeneralMidi2Program.ElectricGuitar_DetunedClean,
                GeneralMidi2Program.MidToneGuitar),
            GetProgramsData(GeneralMidiProgram.ElectricGuitar3,
                GeneralMidi2Program.ElectricGuitar_Muted,
                GeneralMidi2Program.ElectricGuitar_FunkyCutting,
                GeneralMidi2Program.ElectricGuitar_MutedVeloSw,
            ...
            GetProgramsData(GeneralMidiProgram.DistortionGuitar,
                ...
                GeneralMidi2Program.DistortionGuitar_WithFeedback,
            ...
            GetProgramsData(GeneralMidiProgram.SynthBass1,
                ...
                GeneralMidi2Program.SynthBass_Warm,
                GeneralMidi2Program.SynthBass3_Resonance,
            ...
            GetProgramsData(GeneralMidiProgram.SynthBass2,
                ...
                GeneralMidi2Program.SynthBass4_Attack,
                GeneralMidi2Program.SynthBass_Rubber,
            ...
            GetProgramsData(GeneralMidiProgram.Violin,
                ...
                GeneralMidi2Program.Violin_SlowAttack),
            ...
            GetProgramsData(GeneralMidiProgram.FrenchHorn,
                ...
                GeneralMidi2Program.FrenchHorn2_Warm),
            GetProgramsData(GeneralMidiProgram.BrassSection,
                GeneralMidi2Program.BrassSection,
                GeneralMidi2Program.BrassSection2_OctaveMix),
            ...
            GetProgramsData(GeneralMidiProgram.Lead1,
                GeneralMidi2Program.Lead1_Square,
                GeneralMidi2Program.Lead1A_Square2,
                GeneralMidi2Program.Lead1B_Sine),
            GetProgramsData(GeneralMidiProgram.Lead2,
                GeneralMidi2Program.Lead2_Sawtooth,
                GeneralMidi2Program.Lead2A_Sawtooth2,
                GeneralMidi2Program.Lead2B_SawPulse,
                GeneralMidi2Program.Lead2C_DoubleSawtooth,
                GeneralMidi2Program.Lead2D_SequencedAnalog),
            GetProgramsData(GeneralMidiProgram.Lead3,
                GeneralMidi2Program.Lead3_Calliope),
            GetProgramsData(GeneralMidiProgram.Lead4,
                GeneralMidi2Program.Lead4_Chiff),
            GetProgramsData(GeneralMidiProgram.Lead5,
                GeneralMidi2Program.Lead5_Charang,
                GeneralMidi2Program.Lead5A_WireLead),
            GetProgramsData(GeneralMidiProgram.Lead6,
                GeneralMidi2Program.Lead6_Voice),
            GetProgramsData(GeneralMidiProgram.Lead7,
                GeneralMidi2Program.Lead7_Fifths),
            GetProgramsData(GeneralMidiProgram.Lead8,
                GeneralMidi2Program.Lead8_BassLead,
                GeneralMidi2Program.Lead8A_SoftWrl),

            // Synth Pad

            GetProgramsData(GeneralMidiProgram.Pad1,
                GeneralMidi2Program.Pad1_NewAge),
            GetProgramsData(GeneralMidiProgram.Pad2,
                GeneralMidi2Program.Pad2_Warm,
                GeneralMidi2Program.Pad2A_SinePad),
            GetProgramsData(GeneralMidiProgram.Pad3,
                GeneralMidi2Program.Pad3_Polysynth),
            GetProgramsData(GeneralMidiProgram.Pad4,
                GeneralMidi2Program.Pad4_Choir,
                GeneralMidi2Program.Pad4A_Itopia),
            GetProgramsData(GeneralMidiProgram.Pad5,
                GeneralMidi2Program.Pad5_Bowed),
            GetProgramsData(GeneralMidiProgram.Pad6,
                GeneralMidi2Program.Pad6_Metallic),
            GetProgramsData(GeneralMidiProgram.Pad7,
                GeneralMidi2Program.Pad7_Halo),
            GetProgramsData(GeneralMidiProgram.Pad8,
                GeneralMidi2Program.Pad8_Sweep),

            // Synth SFX

            GetProgramsData(GeneralMidiProgram.Fx1,
                GeneralMidi2Program.Fx1_Rain),
            GetProgramsData(GeneralMidiProgram.Fx2,
                GeneralMidi2Program.Fx2_Soundtrack),
            GetProgramsData(GeneralMidiProgram.Fx3,
                GeneralMidi2Program.Fx3_Crystal,
                GeneralMidi2Program.Fx3A_SynthMallet),
            GetProgramsData(GeneralMidiProgram.Fx4,
                GeneralMidi2Program.Fx4_Atmosphere),
            GetProgramsData(GeneralMidiProgram.Fx5,
                GeneralMidi2Program.Fx5_Brightness),
            GetProgramsData(GeneralMidiProgram.Fx6,
                GeneralMidi2Program.Fx6_Goblins),
            GetProgramsData(GeneralMidiProgram.Fx7,
                GeneralMidi2Program.Fx7_Echoes,
                GeneralMidi2Program.Fx7A_EchoBell,
                GeneralMidi2Program.Fx7B_EchoPan),
            GetProgramsData(GeneralMidiProgram.Fx8,
                GeneralMidi2Program.Fx8_SciFi),

            // Ethnic Misc.

            GetProgramsData(GeneralMidiProgram.Sitar,
                GeneralMidi2Program.Sitar,
                GeneralMidi2Program.Sitar2_Bend),
            ...
            GetProgramsData(GeneralMidiProgram.MelodicTom,
                ...
                GeneralMidi2Program.MelodicTom2_Power),
