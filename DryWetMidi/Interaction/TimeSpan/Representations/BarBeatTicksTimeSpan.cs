...
namespace Melanchall.DryWetMidi.Interaction
{
    ...
    public sealed class BarBeatTicksTimeSpan : ITimeSpan, IComparable<BarBeatTicksTimeSpan>, IEquatable<BarBeatTicksTimeSpan>
    {
        ...
        public static bool TryParse(ReadOnlySpan<char> input, out BarBeatTicksTimeSpan? timeSpan)
        {
            return TimeSpanParsers.BarBeatTicksTimeSpanParser.TryParse(input, out timeSpan);
        }
        ...
        public static BarBeatTicksTimeSpan Parse(ReadOnlySpan<char> input)
        {
            return TimeSpanParsers.BarBeatTicksTimeSpanParser.Parse(input);
        }
