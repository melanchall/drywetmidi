...
{
    /// <summary>
    /// Provides factory methods to create events to mark parts of splitted file.
    /// </summary>
    public sealed class SliceMidiFileMarkers
    {
        ...
        /// <summary>
        /// Gets or sets a factory method to create event that will be placed in a splitted MIDI
