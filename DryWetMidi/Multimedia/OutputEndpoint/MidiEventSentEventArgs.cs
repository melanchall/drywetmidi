...
{
    /// <summary>
    /// Provides data for the <see cref="IOutputEndpoint.EventSent"/> event.
    /// </summary>
    public sealed class MidiEventSentEventArgs : EventArgs
    {
        ...
        /// </summary>
        /// <param name="midiEvent">MIDI event sent by <see cref="IOutputEndpoint"/>.</param>
        ...
        /// <summary>
        /// Gets MIDI event sent to <see cref="IOutputEndpoint"/>.
        /// </summary>
