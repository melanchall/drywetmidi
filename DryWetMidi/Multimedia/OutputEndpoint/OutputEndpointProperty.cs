...
{
    /// <summary>
    /// Additional property attached to an instance of the <see cref="OutputEndpoint"/>.
    /// </summary>
    /// <seealso cref="OutputEndpoint"/>
    /// <see cref="OutputEndpointTechnology"/>
    /// <see cref="OutputEndpointOption"/>
    public enum OutputEndpointProperty
    {
        /// <summary>
        ...
        /// <summary>
        /// Manufacturer of an output endpoint (see <c>wMid</c> field
        /// description in <see href="https://docs.microsoft.com/en-us/windows/win32/api/mmeapi/ns-mmeapi-midioutcaps">
        ...
        /// <summary>
        /// Version of an output endpoint driver (see <c>vDriverVersion</c> field
        /// description in <see href="https://docs.microsoft.com/en-us/windows/win32/api/mmeapi/ns-mmeapi-midioutcaps">
        ...
        /// <summary>
        /// Type of an output endpoint on Windows (see <c>wTechnology</c> field
        /// description in <see href="https://docs.microsoft.com/en-us/windows/win32/api/mmeapi/ns-mmeapi-midioutcaps">
        /// MIDIOUTCAPS</see>).
        /// </summary>
        Technology = 3,
        ...
        /// <summary>
        /// Unique identifier of an output endpoint on macOS (see
        ...
        /// <summary>
        /// Number of voices supported by an internal synthesizer endpoint on Windows (see <c>wVoices</c> field
        /// description in <see href="https://docs.microsoft.com/en-us/windows/win32/api/mmeapi/ns-mmeapi-midioutcaps">
        /// MIDIOUTCAPS</see>).
        /// </summary>
        VoicesNumber = 5,
        ...
        /// <summary>
        /// Maximum number of simultaneous notes that can be played by an internal synthesizer endpoint
        ...
        /// <summary>
        /// Channels that an internal synthesizer endpoint responds to on Windows (see <c>wChannelMask</c> field
        /// description in <see href="https://docs.microsoft.com/en-us/windows/win32/api/mmeapi/ns-mmeapi-midioutcaps">
        /// MIDIOUTCAPS</see>).
        /// </summary>
        Channels = 7,
        ...
        /// <summary>
        /// Optional functionality supported by the endpoint on Windows (see <c>dwSupport</c> field
        /// description in <see href="https://docs.microsoft.com/en-us/windows/win32/api/mmeapi/ns-mmeapi-midioutcaps">
        /// MIDIOUTCAPS</see>).
        /// </summary>
        Options = 8,
        ...
        /// <summary>
        /// Owner of an output endpoint driver on macOS (see
