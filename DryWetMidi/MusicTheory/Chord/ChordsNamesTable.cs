        ...
        internal static readonly NameDefinition[] NamesDefinitions = new[]
            {
                ...
                new NameDefinition(new[] { new[] { 0, 4, 6, 11 } }, "maj7b5", "M7b5"),
                new NameDefinition(new[] { new[] { 0, 3, 6, 11 } }, "dimMaj7", "dim(maj7)"),
                new NameDefinition(new[] { new[] { 0, 3, 8, 10 } }, "m7#5", "mAug7", "min7#5"),
                new NameDefinition(new[] { new[] { 0, 4, 7, 10, 20 } }, "7b13", "7(b13)"),
                new NameDefinition(new[] { new[] { 0, 4, 7, 10, 17 } }, "11no9", "7add11"),
                new NameDefinition(new[] { new[] { 0, 4, 7, 11, 17 } }, "maj7add11", "maj7(11)", "M7add11", "M7(11)"),
                new NameDefinition(new[] { new[] { 0, 3, 7, 17 } }, "minAdd11", "mAdd11"),
                    ...
                    foreach (var intervals in nameDefinition.Intervals)
                    {
                        ...
                        foreach (var interval in intervals)
                        {
                            var newNoteName = interval == 0
                                ? noteName
                                : (NoteName)(((int)noteName + interval + Octave.OctaveSize) % Octave.OctaveSize);
