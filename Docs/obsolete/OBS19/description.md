`Splitter.SplitByNotes` method is now obsolete since it has been replaced by [Splitter.SplitByObjects](xref:Melanchall.DryWetMidi.Tools.Splitter.SplitByObjects*) one which can split a MIDI file by objects of difefrent types and with more flexibility.
