...
namespace SimplePlaybackApp
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            _playback = midiFile.GetPlayback(outputEndpoint);
...
> using (var playback = MidiFile.Read("Some MIDI file.mid").GetPlayback(outputEndpoint))
> {
>     playback.Start();
> 
>     // ...
